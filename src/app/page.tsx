      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-sm border-b border-primary/20">
        <div className="container mx-auto px-8 py-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8 text-2xl">
            <a href="#about" onClick={(e) => handleSmoothScroll(e, 'about')} className="hover:text-primary transition-colors cursor-pointer">About</a>
            <a href="#experience" onClick={(e) => handleSmoothScroll(e, 'experience')} className="hover:text-primary transition-colors cursor-pointer">Experience</a>
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden bg-background border-b border-primary/20 transition-all duration-300 overflow-hidden ${isMobileMenuOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0'}`}>
          <nav className="container mx-auto px-8 py-4 space-y-4">
            <a href="#about" onClick={(e) => handleSmoothScroll(e, 'about')} className="block text-xl hover:text-primary transition-colors cursor-pointer">About</a>
            <a href="#experience" onClick={(e) => handleSmoothScroll(e, 'experience')} className="block text-xl hover:text-primary transition-colors cursor-pointer">Experience</a>
            <a href="#skills" onClick={(e) => handleSmoothScroll(e, 'skills')} className="block text-xl hover:text-primary transition-colors cursor-pointer">Skills</a>
            <a href="#contact" onClick={(e) => handleSmoothScroll(e, 'contact')} className="block text-xl hover:text-primary transition-colors cursor-pointer">Contact</a>
          </nav>
        </div>
      </header>
        ...
        <div className="container mx-auto px-6 text-center fade-in relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-3 bg-primary text-white rounded-full hover:bg-primary-dark transition-colors font-medium cursor-pointer"
            >
              Learn More
            </a>
            <a
              ...
              className="px-8 py-3 border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition-colors font-medium cursor-pointer"
            >
              Get in Touch
            </a>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-surface-alt p-8 rounded-lg border border-primary/20">
              <h3 className="text-2xl font-bold mb-4 text-primary">Self Introduction</h3>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute left-6 top-0 w-0.5 bg-primary/30" style={{ height: 'calc(100% - 120px)' }}></div>
      ...
      <section id="skills" className="py-20 bg-surface">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-surface-alt p-8 rounded-lg border border-primary/20">
              <h3 className="text-2xl font-bold mb-6 text-primary">Technologies & Skills</h3>
            ...
            <div className="bg-surface p-8 rounded-lg border border-primary/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  ...
                  className="w-40 py-3 bg-primary text-white rounded-full hover:bg-primary-dark transition-colors font-medium inline-flex items-center justify-center"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-40 py-3 border border-primary text-primary rounded-full hover:bg-primary hover:text-white transition-colors font-medium inline-flex items-center justify-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
